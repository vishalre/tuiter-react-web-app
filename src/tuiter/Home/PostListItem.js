        ...
        <div className="list-group-item">
            <div className="row">
                <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2">
                    <img src={process.env.PUBLIC_URL + posts.image} alt="img"
                         className="wd-rounded-images" width="50px"
                         height="50px"/>
                </div>
            ...
            <div className="row mt-3">
                <div className={`card mx-auto wd-card-bg p-0 ${posts.cardTitle ? 'wd-card-border'
                                                                               : ''}`} id="c1"
                     style={{"width": "30rem"}}>
                    <img src={process.env.PUBLIC_URL + posts.cardImage}
                         className="card-img-top m-0 p-1" alt="img"
